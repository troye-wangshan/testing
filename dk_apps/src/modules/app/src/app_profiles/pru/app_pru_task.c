...
/**
 ****************************************************************************************
 * @brief PRU profile notification about PRU Dynamic has been read by PTU unit
 *
 * @param[in] msgid     Id of the message received.
 * @param[in] param     Pointer to the parameters of the message.
 * @param[in] dest_id   ID of the receiving task instance (TASK_GAP).
 ...
 ****************************************************************************************
 */
int app_pru_dynamic_read_ind_handler(ke_msg_id_t msgid,
                                void const *param,
                                ke_task_id_t dest_id,
                                ke_task_id_t src_id)
{
    return app_pru_dynamic_read_ind_impl(msgid, param, dest_id, src_id);
}
