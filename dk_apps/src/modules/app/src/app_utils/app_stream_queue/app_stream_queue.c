...
/**
 ****************************************************************************************
 * @brief Implementation of packet metrics hook function.
 *
 * The counter of errors shall be increased by one whenever an erroneous packet is reported.
 *
