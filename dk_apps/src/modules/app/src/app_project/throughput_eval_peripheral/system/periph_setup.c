...
{	
    ...
    RESERVE_GPIO( UART1_RX, UART1_RX_GPIO_PORT,  UART1_RX_GPIO_PIN, PID_UART1_RX);    
  	...
  	RESERVE_GPIO( MY1605A, MY1605A_GPIO_PORT,  MY1605A_PIN, PID_GPIO);
//  	RESERVE_GPIO( MY1605B, MY1605B_GPIO_PORT,  MY1605B_PIN, PID_GPIO);
...
void set_pad_functions(void)        // set gpio port function mode
{
    ...
    GPIO_ConfigurePin( UART1_RX_GPIO_PORT, UART1_RX_GPIO_PIN, INPUT, PID_UART1_RX, false );    
	  ...
	  GPIO_ConfigurePin( MY1605A_GPIO_PORT, MY1605A_PIN, OUTPUT, PID_GPIO, false );
//    GPIO_ConfigurePin( MY1605B_GPIO_PORT, MY1605B_PIN, OUTPUT, PID_GPIO, false );    
...
void periph_init(void) 
{
    ...
    // baudr=9-> 115k2
    // mode=3-> no parit y, 1 stop bit 8 data length
