...
enum
{
    ...
    STREAMDATAD_ENABLE_UUID = 0xFFF1,	
    STREAMDATAD_D0_UUID = 0xFFF4,
    STREAMDATAD_D1_UUID =0xFF10,
    STREAMDATAD_D2_UUID =0xFF20,
    STREAMDATAD_D3_UUID =0xFF30,
    STREAMDATAD_D4_UUID =0xFF40,
    STREAMDATAD_D5_UUID =0xFF50,
    STREAMDATAD_D6_UUID =0xFF60,
    STREAMDATAD_D7_UUID =0xFF70,
    STREAMDATAD_D8_UUID =0xFF80,
    STREAMDATAD_D9_UUID =0xFF90,
